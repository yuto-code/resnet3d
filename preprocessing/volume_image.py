...
class VolumeImageLoaderIterator(Iterator):
    ...
    def make_batches(self, index_array):
        ...
        if self.class_mode == 'sparse':
            ...
            batch_y = np.arange(len(index_array))
        ...
        if batch_y.shape[0] == 4:
            print("index_array:", index_array)
            print("make_batches x: ", batch_x.shape)
            print("make_batches y: ", batch_y.shape)
    ...
    def next(self):
        ...
        return self.make_batches(index_array)

    def _get_batches_of_transformed_samples(self, index_array):
        x, y = self.make_batches(index_array)
        return x, y
